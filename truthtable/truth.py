...
class Truth:
    ...
    def insert_operators_into_expression(self, expression: str) -> str:
        return (
            expression
            .replace("&", " and ")
            .replace("|", " or ")
    ...
    def get_beautiful_expression(self):
        return (
            self.expression
            .replace("&", "∧")
            .replace("|", "∨")
    ...
    def get_table_with_replaced_operations(self) -> List[str]:
        table = []
    ...
    def __str__(self):
        truth_table = [
            f"Expression: {self.get_beautiful_expression()}\n"
